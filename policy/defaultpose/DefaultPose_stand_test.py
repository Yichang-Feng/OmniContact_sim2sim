...
class DefaultPoseStandTest(FSMState):
    def __init__(self, state_cmd:StateAndCmd, policy_output:PolicyOutput):
        super().__init__()
        self.state_cmd = state_cmd
        self.policy_output = policy_output
        self.name = FSMStateName.DEFAULTPOSE
        self.name_str = "default_pose_stand_test"
        self.alpha = 0.
        self.cur_step = 0
    ...
    def enter(self):
        print("Moving to default pos(configuration A) [Stand Test Version].")
        self.total_time = 2.0
    ...
    def checkChange(self):
        if(self.state_cmd.skill_cmd == FSMCommand.LOCO):
            ...
            self.state_cmd.skill_cmd = FSMCommand.INVALID
            print("\n[DefaultPoseStandTest] 🎮 收到手柄 L1+A 指令！允许直接从 DefaultPose 切换至 SKILL_OmniContact 预备站立态！")
